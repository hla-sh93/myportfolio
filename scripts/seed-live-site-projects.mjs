...
const DEFS = [
  {
    ...
    descEn:
      "Twelve maritime authorities, twelve separate clients, one problem repeated: a flag state has to publish the same things — services, certification, approved organisations, document verification — and still look like itself while doing it. I designed and built each front end. Zimbabwe runs deep green and gold; Nicaragua is cream and navy. The same skeleton underneath, no two alike on the surface. All twelve for clients in the UAE.",
    descAr:
      "اثنتا عشرة هيئة بحرية، واثنا عشر عميلًا منفصلين، ومسألة واحدة تتكرّر: دولة العَلَم تنشر المحتوى نفسه — الخدمات، وإصدار الشهادات، والمؤسسات المعتمدة، والتحقّق من الوثائق — وعليها أن تظلّ محتفظة بهويتها وهي تفعل ذلك. صمّمت كل واجهة وبنيتها. زيمبابوي بالأخضر الغامق والذهبي، ونيكاراغوا بالكريمي والكحلي. الهيكل واحد في العمق، ولا يتشابه اثنان في السطح. العمل كلّه لعملاء في الإمارات.",
    category: "WEBSITES",
